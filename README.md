...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-oow88go.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-oow88go.containers.anotherwebservice.com/
...
```
git clone git@github.com:zqwm1/container-oow88go.git
cd container-oow88go
```
...
```
docker attach container-oow88go
```
